...
volatile INT8 flagspeed=1, flagdist=0;
...
void main(void)
{
    ...
    //INT8 meas_distance = 0;
     ...
     INT8 nicola_speed;
    INT8 flag=0,flag_acc = 0,flagd1=1,flagd2=0,deltaX=0,acceleration=0;
    INT32 count=0;
    ...
    for(;;)
    {
        ...
        if(carParamsUpdated)
        {
            ...
            else
            {
                ...
                {  
                    ...
                    controlOutput1 = 1*error/1 + 1*errInteg/50;
                    controlOutput1 = limit(controlOutput1, 0, 100);
        ...
        else if(carInputsUpdated)
        {
            ...
            if((carInputs.controls & CRUISE) && (carParams.speed > 0))
            {
                ...
                if(carDistance.distance < (des_distance+30 ))
